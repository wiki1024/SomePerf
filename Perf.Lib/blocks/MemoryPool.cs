...
namespace Perf.Lib.blocks
{
    ...
    public class MemoryPool : IDisposable
    {
        ...
        /// </summary>
        private const int _blockStride = 1024*1024;

        /// <summary>
        /// I don't understand line 116 for finding first offset. 
        /// </summary>
        private const int _kestrelBlockStride = 4096;
        /// <summary>
        ...
        public static MemoryPool Shared { get; } = new MemoryPool();
        ...
        private MemoryPoolBlock AllocateSlab()
        {
            ...
            var firstOffset = (int)((_kestrelBlockStride - 1) - ((ulong)(basePtr + _kestrelBlockStride - 1) % _kestrelBlockStride));
